...
triggerGmcpCommunication :: MBTrigger u GMCP AttrString
triggerGmcpCommunication = marr $ \g ->
    case gmcpModule g of
        "comm.channel" -> return $ toAttrString $ rstrip $ fromMaybe "" $ getStringField "msg" g
        _ -> failT
  where
